...
int main()
{
	...
	while (choice != 6)
	{
		...
		cout << "Что бы вы хотели сделать?" << endl << "1: Добавить книгу." << endl << "2: Редактировать книгу." << endl << "3: Найти книгу." << endl << "4: Список книг." << endl << "5: Статистика." << endl << "6: Выход." << endl;
		cin >> choice;
		...
		if (choice == 1)
		{
			...
			cout << "Введите Id, название, автора, стоимость и тираж" << endl;
			Book book;
